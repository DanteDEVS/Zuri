...
namespace Zuri\Libraries\libasynCurl;

use Closure;
use InvalidArgumentException;
use pocketmine\plugin\PluginBase;
use pocketmine\scheduler\ClosureTask;
use Zuri\Libraries\libasynCurl\thread\CurlDeleteTask;
use Zuri\Libraries\libasynCurl\thread\CurlGetTask;
use Zuri\Libraries\libasynCurl\thread\CurlPostTask;
use Zuri\Libraries\libasynCurl\thread\CurlPutTask;
use Zuri\Libraries\libasynCurl\thread\CurlThreadPool;
